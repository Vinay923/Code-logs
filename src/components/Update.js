...
function Update() {
  ...
  useEffect(()=>{
    ...
    const fetchData = async ()=>{
      const res = await axios.get(`https://gorgeous-crown-calf.cyclic.cloud/api/posts/${id}`)
  ...
  const handleSubmit =async (e)=>{
    ...
    toggleProcess()
    const res = await axios.patch(`https://gorgeous-crown-calf.cyclic.cloud/api/posts/${id}`,{title,description:des,code,author,tags:array,email})
    toggleProcess()
